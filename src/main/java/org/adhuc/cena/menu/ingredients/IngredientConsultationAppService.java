...
/**
 * An application service for ingredients consultation. Ingredient consultation provides query methods available for
 * every user.
 *
 ...
 * @since 0.1.0
 */
public interface IngredientConsultationAppService {
