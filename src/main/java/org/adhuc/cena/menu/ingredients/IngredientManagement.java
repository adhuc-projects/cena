...
/**
 * An application service for ingredients management. This service provides command methods for ingredient manipulation
 * and is available only for ingredient manager.
 *
