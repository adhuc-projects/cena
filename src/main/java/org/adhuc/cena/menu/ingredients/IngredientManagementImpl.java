...
/**
 * An {@link IngredientManagement} implementation.
 *
...
@ApplicationService("ingredientManagement")
class IngredientManagementImpl implements IngredientManagement {

    @NonNull
    private IngredientCreation ingredientCreation;
    @NonNull
    private IngredientDeletion ingredientDeletion;

    @Override
    public void createIngredient(@NonNull CreateIngredient command) {
        log.info("Create ingredient from command {}", command);
        ingredientCreation.createIngredient(command);
    }

    @Override
    public void deleteIngredient(@NonNull DeleteIngredient command) {
        ingredientDeletion.deleteIngredient(command);
    }
