...
/**
 * The {@link IngredientAdministrationAppServiceImpl} test class.
 *
...
class IngredientAdministrationAppServiceImplShould {

    private IngredientRepository ingredientRepository;
    private IngredientAdministrationAppServiceImpl service;
    @Mock
    ...
    void setUp() {
        ...
        service = new IngredientAdministrationAppServiceImpl(new IngredientDeletionService(ingredientRelatedService, ingredientRepository));
