...
/**
 * The {@link IngredientConsultationAppServiceImpl} test class.
 *
...
class IngredientConsultationAppServiceImplShould {

    private IngredientRepository ingredientRepository;
    private IngredientConsultationAppServiceImpl service;

    @BeforeEach
    void setUp() {
        ingredientRepository = new InMemoryIngredientRepository();
        service = new IngredientConsultationAppServiceImpl(ingredientRepository);
    }
