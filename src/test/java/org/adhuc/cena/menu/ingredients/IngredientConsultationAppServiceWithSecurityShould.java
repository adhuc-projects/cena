...
/**
 * The {@link IngredientConsultationAppServiceImpl} security tests.
 *
...
class IngredientConsultationAppServiceWithSecurityShould {

    @Autowired
    private IngredientConsultationAppService service;
    @Autowired
