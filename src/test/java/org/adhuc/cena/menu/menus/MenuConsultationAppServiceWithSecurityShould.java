...
@DisplayName("Menu consultation service with security should")
class MenuConsultationAppServiceWithSecurityShould {

    @Autowired
    private MenuConsultationAppService service;
    @Autowired
