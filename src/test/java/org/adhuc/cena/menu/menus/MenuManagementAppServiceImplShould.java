...
/**
 * The {@link MenuManagementAppServiceImpl} test class.
 *
...
class MenuManagementAppServiceImplShould {

    private MenuRepository menuRepository;
    private RecipeConsultationAppService recipeAppService;
    private MenuManagementAppServiceImpl service;

    @BeforeEach
    void setUp() {
        menuRepository = new InMemoryMenuRepository();
        recipeAppService = mock(RecipeConsultationAppService.class);
        service = new MenuManagementAppServiceImpl(new MenuCreationService(menuRepository, recipeAppService), menuRepository);
