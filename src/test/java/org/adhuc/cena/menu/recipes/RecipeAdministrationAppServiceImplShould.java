...
/**
 * The {@link RecipeAdministrationAppServiceImpl} test class.
 *
...
class RecipeAdministrationAppServiceImplShould {
    ...
    private RecipeAdministrationAppServiceImpl service;

    @BeforeEach
    void setUp() {
        recipeRepository = new InMemoryRecipeRepository();
        service = new RecipeAdministrationAppServiceImpl(recipeRepository);
