...
/**
 * The {@link RecipeAdministrationAppServiceImpl} security tests.
 *
...
class RecipeAdministrationAppServiceImplWithSecurityShould {

    @Autowired
    private RecipeAdministrationAppService service;
    @Autowired
